package com.example.zhouy.news_refactor;
...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.example.zhouy.news_refactor.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.example.zhouy.news_refactor.GlideOptions().apply(toSet));
    }
  }
}
